...
SELECT NOME FROM dbo.CLIENTES WHERE SEXO ='M' AND CIDADE = 'Sorocaba'
SELECT NOME FROM dbo.CLIENTES WHERE SEXO ='F'
SELECT TELEFONE, NOME FROM dbo.CLIENTES ORDER BY NOME
...
SELECT NOME_CATEGORIA FROM dbo.CATEGORIA WHERE = 'Ação'
...
SELECT FILME FROM dbo.FILME WHERE DIRETOR='Shawn Levy'
SELECT DIRETOR FROM dbo.FILME
SELECT VALOR_LOCACAO, RESERVADA FROM dbo.FILME WHERE VALOR_LOCACAO > 5
SELECT VALOR_LOCACAO, RESERVADA FROM dbo.FILME WHERE VALOR_LOCACAO < 5
SELECT VALOR_LOCACAO, RESERVADA FROM dbo.FILME WHERE VALOR_LOCACAO > 5 and COD_CATEGORIA='Aventura'	
SELECT DISTINCT DIRETOR FROM dbo.FILME
SELECT MIN(VALOR_LOCACAO) FROM dbo.FILME
SELECT MAX(VALOR_LOCACAO) FROM dbo.FILME
SELECT COUNT(FILME) FROM dbo.FILME
...
SELECT COD_CLIENTE FROM dbo.LOCACOES WHERE DATA_RETIRADA >3

select * from dbo.LOCACOES
SELECT COD_FILME FROM dbo.LOCACOES WHERE COD_CLIENTE='Renata Cristina'
